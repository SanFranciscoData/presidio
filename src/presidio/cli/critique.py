...
from presidio.critique.models import CritiqueConfig
from presidio.critique.runner import CritiqueRunner
...
from presidio.models.trial.config import AgentConfig, EnvironmentConfig, TaskConfig
...
def run_command(
    job_dir: Annotated[Path, typer.Argument(help="Path to an existing Presidio job dir")],
    prompt: Annotated[
        Path,
        Option(
            "-p",
    ...
    config_path: Annotated[
        ...
        Option(
            ...
            "Should implement the schema of presidio.models.job.config:JobConfig. "
    ...
    """Run sandboxed critiques over completed trials in a Presidio job."""

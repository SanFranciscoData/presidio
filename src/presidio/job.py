...
from presidio.metrics.base import BaseMetric
from presidio.metrics.factory import MetricFactory
from presidio.metrics.mean import Mean
from presidio.models.job.config import (
    DatasetConfig,
    JobConfig,
)
from presidio.models.job.lock import LOCK_FILENAME, JobLock, build_job_lock
from presidio.models.job.result import EvalsRewardsMap, JobResult, JobStats
from presidio.models.trial.config import TaskConfig, TrialConfig
...
from presidio.utils.pass_at_k import compute_pass_at_k_by_evals
...
class Job:
    ...
    def _write_job_lock(self) -> None:
        ...
        if self._job_lock_path.exists():
            ...
            self._job_lock.presidio = existing_job_lock.presidio

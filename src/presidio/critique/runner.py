...
from presidio.agents.installed.base import BaseInstalledAgent
from presidio.critique.models import (
    CritiqueConfig,
    CritiqueItem,
    CritiqueItemResult,
    CritiqueJobResult,
...
from presidio.models.job.lock import LOCK_FILENAME, JobLock, TrialLock
from presidio.models.task.task import Task
from presidio.models.trial.config import TaskConfig
from presidio.models.trial.paths import TrialPaths
from presidio.models.trial.result import ExceptionInfo, TimingInfo, TrialResult
from presidio.trial.execution import TrialExecution
...
class CritiqueRunner:
    ...
    def collect_items(self) -> list[CritiqueItem]:
        if not is_job_dir(self.source_job_dir):
            raise ValueError(f"Not a Presidio job directory: {self.source_job_dir}")

...
from presidio.models.trial.config import AgentConfig, EnvironmentConfig
from presidio.models.trial.result import AgentInfo, ExceptionInfo, TimingInfo


class CritiqueConfig(BaseModel):
    """Configuration for one critique run over an existing Presidio job."""

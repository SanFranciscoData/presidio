...
from presidio.agents.installed.base import (
    BaseInstalledAgent,
    CliFlag,
...
from presidio.utils.trajectory_metrics import (
    extra_with_context_metrics,
    populate_context_from_final_metrics,
)
from presidio.utils.trajectory_utils import format_trajectory_json
...
class Codex(BaseInstalledAgent):
    ...
    def populate_context_post_run(self, context: AgentContext) -> None:
        ...
        and propagates usage metrics back to the Presidio context.
        """

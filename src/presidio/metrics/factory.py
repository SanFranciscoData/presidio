...
from presidio.metrics.max import Max
from presidio.metrics.mean import Mean
from presidio.metrics.min import Min
from presidio.metrics.sum import Sum
from presidio.models.metric.type import MetricType

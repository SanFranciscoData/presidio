...
class EnvironmentCapabilities(BaseModel):
    ...
    """Whether the environment can restrict egress to declared hostnames
    (network_mode='allowlist')."""

    dynamic_network_policy: bool = False
    """Whether the environment can switch network policy after start, enabling
    [agent] and [verifier] phase overrides."""

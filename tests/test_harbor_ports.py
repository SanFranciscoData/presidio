...
from presidio.environments.resource_policies import validate_resource_values
...
from presidio.models.task.verifier_mode import resolve_task_verifier_mode
...
def test_resource_capabilities_reject_unsupported_request():
    ...
    with pytest.raises(ValueError, match="CPU resource requests"):
        from presidio.environments.resource_policies import validate_resource_capabilities

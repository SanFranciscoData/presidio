"""BaseEnvironment.download_dir_with_exclusions tests (vendored from harbor's
tests/unit/environments/test_base_download_dir_exclusions.py, including the
archive-collision fix from harbor commit d313d60d)."""

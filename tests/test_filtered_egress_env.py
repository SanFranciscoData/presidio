...
from presidio.environments.docker.docker import DockerEnvironment
from presidio.environments.modal import ModalEnvironment, _ModalDinD, _ModalDirect
...
def test_docker_proxy_compose_does_not_inject_proxy_env_into_main(tmp_path):
    ...
    assert main["networks"] == ["presidio-egress-internal"]
